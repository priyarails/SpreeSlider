...
ActiveRecord::Schema.define(version: 20160522093433) do
  ...
  create_table "spree_slide_slider_locations", force: :cascade do |t|
    t.integer "slide_id",          limit: 4
    t.integer "slide_location_id", limit: 4
  end

  add_index "spree_slide_slider_locations", ["slide_id"], name: "index_spree_slide_slider_locations_on_slide_id", using: :btree
  add_index "spree_slide_slider_locations", ["slide_location_id"], name: "index_spree_slide_slider_locations_on_slide_location_id", using: :btree

  create_table "spree_slider_locations", force: :cascade do |t|
    t.string   "name",       limit: 255
    t.datetime "created_at"
    t.datetime "updated_at"
  end
